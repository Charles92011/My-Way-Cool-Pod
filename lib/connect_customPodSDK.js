...
([function (e, t, n) {
			...
			var c = function (e) {
				function t() {
					...
					return e.sc = window.parent[window.frameElement.name],
					e
				}
				return function (e, t) {
				...
				s(t, [{
							...
							value: function (e, t, n) {
								var i = !0;
								(void 0 === t || t.length <= 0) && (i = !1),
								(void 0 === n || n.length < 6) && (i = !1),
								i ? (this.registerCallback("config", e), this.communicateToParent("init", {
										customPodID: t,
										customPodVersion: n
							...
							value: function () {
								...
								this.processCallback("syncModeChanged", this.isSynced)
							}
						}, {
							...
							value: function () {
								...
								Object.keys(this.sc._userList).map(function (t) {
							...
							key: "getBreakoutRoomDetails",
							value: function (e) {
								return this.sc.getBreakoutRoomDetails(e)
							}
						}, {
							key: "getBreakoutRoomsList",
							value: function () {
								return this.sc.getBreakoutRoomsList()
							}
						}, {
							key: "getMyBreakoutRoomDetails",
							value: function () {
								return this.sc.getMyBreakoutRoomDetails()
							}
						}, {
							...
							value: function (e, t, n, i) {
								i = void 0 !== i && i,
								this.dispatch("dispatchSyncMessage", {
									msgNm: e,
									msgVal: t,
									isDelta: n,
									_echo: i
							...
							key: "k_HOST",
							get: function () {
								return this.sc.k_HOST
							}
						}, {
							key: "k_PARTICIPANT",
							get: function () {
								return this.sc.k_PARTICIPANT
							}
						}, {
							key: "k_PRESENTER",
							get: function () {
								return this.sc.k_PRESENTER
							}
						}, {
							key: "language",
							get: function () {
							...
							key: "AGREE",
							get: function () {
								return this.sc.AGREE
							}
						}, {
							key: "AGREE_DISAGREE_CLEAR",
							get: function () {
								return this.sc.AGREE_DISAGREE_CLEAR
							}
						}, {
							key: "APPLAUSE",
							get: function () {
								return this.sc.APPLAUSE
							}
						}, {
							key: "BUILD_NO",
							get: function () {
								return this.sc.BUILD_NO
							}
						}, {
							key: "CLEAR_STATUS",
							get: function () {
								return this.sc.CLEAR_STATUS
							}
						}, {
							key: "DATE",
							get: function () {
							...
							key: "DISAGREE",
							get: function () {
								return this.sc.DISAGREE
							}
						}, {
							key: "LAUGHTER",
							get: function () {
								return this.sc.LAUGHTER
							}
						}, {
							key: "LOWER_HAND",
							get: function () {
								return this.sc.LOWER_HAND
							}
						}, {
							key: "RAISE_HAND",
							get: function () {
								return this.sc.RAISE_HAND
							}
						}, {
							key: "SLOW_DOWN",
							get: function () {
								return this.sc.SLOW_DOWN
							}
						}, {
							key: "SPEAK_LOUDER",
							get: function () {
								return this.sc.SPEAK_LOUDER
							}
						}, {
							key: "SPEAK_SOFTER",
							get: function () {
								return this.sc.SPEAK_SOFTER
							}
						}, {
							key: "SPEED_UP",
							get: function () {
								return this.sc.SPEED_UP
							}
						}, {
							key: "STEP_AWAY",
							get: function () {
								return this.sc.STEP_AWAY
							}
						}, {
							key: "STEP_IN",
							get: function () {
								return this.sc.STEP_IN
							}
						}, {
							key: "VERSION",
							get: function () {
				...
				return i(e, [{
							...
							value: function (e, t, n) {
								if (s(t)) {
									...
									if (n) {
										var o = -1;
										!0 !== i.objectIdListeners.has(n) ? i.objectIdListeners.set(n, []) : o = i.objectIdListeners.get(n).findIndex(r),
										-1 === o && i.objectIdListeners.get(n).push(t)
									} else {
							...
							value: function (e, t, n) {
								...
								if (r) {
									...
									if (s && (r.eventTypeListeners = s, i = !0), n)
										u(n, t, r) && (i = !0);
									else {
										var c = !0,
										a = !1,
										l = void 0;
										try {
											for (var f, h = r.objectIdListeners.keys()[Symbol.iterator](); !(c = (f = h.next()).done); c = !0) {
												u(f.value, t, r) && (i = !0)
											}
										} catch (e) {
											a = !0,
							...
							value: function (e, t) {
								...
								return i && (c(e, i.eventTypeListeners) && (n = !0), t && c(e, i.objectIdListeners.get(t)) && (n = !0)),
								performance && performance.now(),
								n
							}
						}
